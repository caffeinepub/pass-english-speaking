...
export class Backend implements backendInterface {
    ...
    async getAllCompletedDays(): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCompletedDays();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCompletedDaysCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompletedDaysCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCourseProgress(arg0: Principal): Promise<[bigint, bigint]> {
        if (this.processError) {
            try {
    ...
    async getDay1TestAttempts(arg0: Principal): Promise<Array<TestAttempt>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDay1TestAttempts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUnlockedDaysCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUnlockedDaysCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserHighScore(arg0: Principal): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserHighScore(arg0);
    ...
    async hasUserPassedTest(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasUserPassedTest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isDayLocked(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isDayLocked(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isDayUnlocked(arg0: Principal, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isDayUnlocked(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unlockDayForUser(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
